...
Forbidden= discord.Embed(title="Permission Denied", description="1) Veuillez vérifier si vous êtes autorisé à effectuer cette action ou non. \n2) Please check whether my role has permission to perform this action in this channel or not. \n3) Please check my role position.", color=0x00ff00)
client = Bot(description="BENJIFR c'est le best", command_prefix="/", pm_help = True)
...
client.run(os.getenv('NTgzNjAzNjU4OTY1NjQ3MzYx.Xgluag.DjoDZLwl5OP_8E2j_FNd_-18gOY'))
